<template>
    ...
    <AdminLayout>
        <q-page class="q-pa-md">
                ...
                <q-card-section>
                    <div class="row q-col-gutter-sm">
                            ...
                            <div class="row q-col-gutter-sm">
                                ...
                                <div class="col-lg-4 co-12">
                                    ...
                                    >
                                        ...
                                        <template v-slot:hint>تاریخ خرید</template>
                                    </q-select>
                                </div>
                                <div class="col-lg-4 co-12">
                                    <q-select
                        ...
                        <div class="col-12">
                            <div class="q-my-md">
                                <div class="rb-add">
                                    <q-btn type="submit" class="rb-action rb-large" label="ویرایش مستاجر"
                                           @click="editOwner"
                                           :loading="isLoading"/>
                                </div>
                            </div>
            ...
            <Documents
                title="فایل های بارگذاری شده مستاجرین"
                description="مدارک و فایل های مربوط به مستاجرین را می توانید بارگذاری نمایید"
                :model-type="modelType"
                :id="user.id"
                :redirect-route="route('admin.occupants.edit',user.id)"
            />
        </q-page>
    </AdminLayout>
</template>
...
export default {
    ...
    setup() {
        ...
        const editOwner = () => {
            submitForm('admin.occupants.update', user.id);
        };
